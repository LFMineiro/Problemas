...
def calcular_arctg(x, iteracoes):
    ...
    for n in range(iteracoes):
        ...
        arctgs.append(serie)
    return arctgs
def calcular_piaprox(teta1, teta2, teta3):
    pi_aprox= []
...
def main(): 
    ...
    teta1 = calcular_arctg(1/2, n)
    teta2 = calcular_arctg(1/5, n)
    teta3 = calcular_arctg(1/8, n)
    pi_aproximado=calcular_piaprox(teta1, teta2, teta3)
